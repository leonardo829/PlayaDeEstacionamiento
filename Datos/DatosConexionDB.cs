...
namespace Datos
{
    ...
    public class DatosConexionDB
    {
        ...
        public string cadenaConexion = @"Data Source=DESKTOP-LF6ERKD\SQLEXPRESS;Initial Catalog=PlayaEstacionamiento;Integrated Security=True;Connect Timeout=30;TrustServerCertificate=true;Encrypt=True";
